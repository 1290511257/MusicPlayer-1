...
/**
 * 系统相关的工具类
 * @typename SystemUtils
 * @author Jerry
 * @time 2015年1月27日 上午10:38:30
 * @version V1.1.5
 */
public class SystemUtils {
	private final static String mTag = "SystemUtils";
	/** 获取android系统版本号 */
	...
	public static String getSystemProperty(String key) {
		...
		try {
			...
			Method m = c.getMethod("getTitles", String.class);
	...
	public static List<String> getSystemLibs() {
		...
		LogUtils.d(mTag, "SystemLibs: " + listLibNames);
		return listLibNames;
	}
